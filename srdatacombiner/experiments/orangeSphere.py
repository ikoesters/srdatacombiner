...
class UNSW_Strikes(Experiments):
    def __init__(self) -> None:
        ...
        self.interpolation_master_args = (
            "../../data/25_04_03_OrangeSphere_9.5mmBlade_1to10mps_1mpsSteps_3N/01ms/01/S03-0403123029.txt",
            "sensorprobe",
        )
        super().__init__()
